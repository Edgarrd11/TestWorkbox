require([
    ...
    (async () => {
        ...
        const template = {
            ...
            title: "Unidades Totales y Vendidas por Proyecto | {PROYECTO}",
            content: [
              {
        ...
        // - - - - - -  -
        const municipiosLayer = new FeatureLayer({ url: 'https://services6.arcgis.com/cdylwBTTDF2F9FTY/ArcGIS/rest/services/BCS/FeatureServer' });
        ...
        const map = new Map({
            ...
            layers: [proyectosLayer,municipiosLayer, bufferLayer, graphicsLayer]
        });
        ...
        const municipiosLayerView = await view.whenLayerView(municipiosLayer);
       
        reactiveUtils.when(
            () => !municipiosLayerView.dataUpdating,
            async () => {
        ...
        async function queryLayerViewAgeStats(buffer) {
            ...
            const query = municipiosLayerView.layer.createQuery();
            ...
            const results = await municipiosLayer.queryFeatures(query);
